...
class BuyTicketPage extends StatelessWidget {
  ...
  const BuyTicketPage({Key key, this.titleMovie, this.imageMovie})
      : super(key: key);
...
class _ItemTime extends StatelessWidget {
  ...
  const _ItemTime({Key key, this.time}) : super(key: key);
...
class _ItemDate extends StatelessWidget {
  ...
  const _ItemDate({Key key, this.date}) : super(key: key);
